...
${SNP_REANNOTATOR} --logfile lookup_index.log lookup_index -i test_extracted_segments.tsv --index-file dbsnp_index_hg18_251.db -O affy_marker_definitions_mod.tsv -o affy_marker_definitions_reannot.tsv
