...
CONFIG_VALUES = [
    ...
    {'ome_config_value' : 'omero.biobank.queue_manager.engine',
     ...
     'optional'         : False},
    {'ome_config_value' : 'omero.biobank.queue_manager.host',
     'kb_config_value'  : 'QUEUE_MANAGER_ENGINE_HOST',
     'optional'         : False},
    {'ome_config_value' : 'omero.biobank.queue_manager.port',
     'kb_config_value'  : 'QUEUE_MANAGER_ENGINE_PORT',
     'optional'         : True},
